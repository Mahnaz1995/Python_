...
#csvPath=r"C:\Users\mahna\OneDrive\Desktop\Github\Phyton\PyBank\Resources\budget_data.csv"

pwf = os.path.abspath(__file__)
pwd = os.path.dirname(pwf)

#Specifying the file to read to
csvPath = os.path.join(pwd, r"C:\Users\mahna\OneDrive\Desktop\Github\Phyton\PyBank\Resources\budget_data.csv")
